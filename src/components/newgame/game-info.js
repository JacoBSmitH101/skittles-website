import { Button, Card, CardContent, CardHeader, Divider, FormControl, FormControlLabel, FormLabel, Grid, Radio, RadioGroup, TextField, Typography } from "@mui/material";
    ...
    <Card>
      ...
      <CardContent>
        <Grid container spacing={3}>
          ...
          <Grid item md={12} xs={12}>
            <TextField fullWidth label="Alley" name="alley" required variant="outlined" value={gameInfo.alley} onChange={handleGameInfoInput} />
          </Grid>
